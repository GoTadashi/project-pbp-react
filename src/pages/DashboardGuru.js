            ...
            <div className="div">
                ...
                <div className="overlap-2">
                            ...
                            <div className="overlap-4">
                                ...
                                <div className="group-4">
                                    <div className="overlap-5">
                                        ...
                                        <div className="group-5">
                                            <div className="text-wrapper-7">RATA-RATA RAPOR SEMESTER INI</div>
                                            <div className="SEMESTER">Semester 3</div>
                                        </div>
                                        <img className="element-3" alt="Element" src="/img/3-1.png" />
                                ...
                                <div className="group-6">
                                    ...
                                    <p className="selamat-datang-BU">
                                        ...
                                        <span className="span">, silahkan input matapelajaran yang anda ampu semester ini!</span>
                                    </p>
                    ...
                    <div className="DAFTAR-MATAPELAJARAN">
                        <div className="overlap-6">
                            ...
                            <div className="overlap-group-3">
                                ...
                                <img className="icon-book" alt="Icon book" src="/img/icon-book.png" />
                            </div>
                        </div>
                    </div>
                    <div className="DAFTAR-GURU">
                        <div className="overlap-6">
                            ...
                            <img className="icon-chalkboard" alt="Icon chalkboard" src="/img/icon-chalkboard-teacher.png" />
                        </div>
                    </div>
                    <div className="DAFTAR-SISWA">
                        <div className="overlap-6">
                            ...
                            <img className="icon-siswa" alt="Icon siswa" src="/img/icon-siswa.png" />
                        </div>
                    </div>
                </div>
                <div className="INPUT-PENGUMUMAN">
                    <div className="overlap-6">
                        ...
                        <img className="icon-megaphone" alt="Icon megaphone" src="/img/icon-megaphone.png" />
                    </div>
                </div>
